...
Current cross-service operational information is published at <https://status.gapwise.ca>. That status page is operator-maintained and must not be treated as a continuous synthetic monitor, historical uptime record, or contractual SLA.
