...
The repository README provides the public overview; these documents define the implementation and security contract in more detail.

## Core design

- [`ARCHITECTURE.md`](ARCHITECTURE.md) — trust boundaries, canonical ownership, and data flow.
- [`API.md`](API.md) — browser delegation endpoints and the current registered MCP surface.
